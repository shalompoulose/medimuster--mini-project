  ...
  <div class="team py-5">
    <div class="container py-lg-5 py-md-4">
      ...
      <div class="row team-row">
        ...
        $qry = mysqli_query($conn, "SELECT DISTINCT l.`lid`,u.* FROM `login` l,`user` u WHERE l.`uid`=u.`uid` AND l.`status`='Pending'");
            ...
            <div class="col-lg-3 col-6 team-wrap mt-4 pt-lg-2" style="margin-bottom: 25px">
              <div class="team-info">
                <div class="column position-relative img-circle">
                  <a href="ViewuserRequestById.php?id=<?php echo $row['lid'] ?>"><img src="../<?php echo $row['img'] ?>" alt="" class="img-fluid" /></a>
                </div>
                <div class="column-btm">
                  <h3 class="name-pos"><a href="ViewuserRequestById.php?id=<?php echo $row['lid'] ?>"><?php echo $row['name'] ?>
                    </a></h3>
