...
$lid = $_GET['id'];
$qry = mysqli_query($conn, "SELECT DISTINCT l.`lid`,u.* FROM `login` l,`user` u WHERE l.`uid`=u.`uid` AND l.`status`='Approved' AND l.`lid`='$lid'");
            ...
            <div class="container py-lg-5 py-md-4 py-2">
                ...
                <div class="row bottom-ab-grids">
                    <div class="col-lg-6 bottom-ab-left align-self">
                        ...
                        <a href="../Action/RejectRequest.php?id=<?php echo $row['lid'] ?>"><button type="button" class="btn btn-outline-primary">Remove User</button></a>
                        <hr style="border: 2px solid #2CAEE2; ">
