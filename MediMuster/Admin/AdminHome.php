    ...
    <div class="w3l-banner-content">
      <div class="container">
        <div class="bannerhny-info text-center">
          <h6 class="title-subhny mb-2">MEDIMUSTER</h6>
          <h3 class="">Get Vaccinated. And Wear Mask.</h3>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="box-wrap">
              ...
              <p class="mt-3">We have our best and elite team for your your service and safety.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 mt-md-0 mt-4">
            <div class="box-wrap">
              ...
              <p class="mt-3">We provide you the better quality assurance through our we site.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 mt-lg-0 mt-4">
            <div class="box-wrap">
              ...
              <p class="mt-3">We provide our help throughout the entire globe to save millions.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
      <div class="row w3l-content-inf mt-lg-5 pt-lg-5">
        <div class="col-lg-5 w3l-content-left mt-lg-4">
          ...
          <h3 class="title-w3l mb-4">Changing the way you receive vaccination.</h3>
          
        </div>
        <div class="col-lg-7 w3l-content-right pl-lg-5 mt-lg-4">
          <p class="para-sub pr-lg-5 mt-md-4 mt-3 mx-auto">Medi Muster is a web application for online vaccine registration.
              Medi Muster web application which shall be used to register,
              get information about vaccine availability, and have booking systems...
          </p>
          <p class="para-sub pr-lg-5 mt-md-4 mt-3 mx-auto">The purpose of this project is to check the availability of vaccines,
              update the current vaccine availability and to register vaccines by the users.
          </p>
      ...
      <div class="row whybox-wrap">
        <div class="col-lg-6 whybox-wrap-left">
          <div class="title-content text-left">
            ...
            <h3 class="title-w3l mb-sm-5 mb-4 pb-2">Why You Should Choose MediMuster?.</h3>
          </div>
          ...
          <div class="whybox-wrap-grid mb-4">
            ...
            <div class="info">
              ...
              <p class="mt-3">We have 10 years of experience in handling with other healthcare services. </p>
            </div>
          </div>
          <div class="whybox-wrap-grid mb-4">
            <div class="icon">
            ...
            <div class="info">
              ...
              <p class="mt-3">We provide you the free service through out or web service . </p>
            </div>
          </div>
          <div class="whybox-wrap-grid mb-4">
            <div class="icon">
            ...
            <div class="info">
              ...
              <p class="mt-3">Through our site you can be sure that you will get vaccinated 100%. </p>
            </div>
          </div>
        </div>
